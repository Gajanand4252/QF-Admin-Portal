...
document.getElementById('loginForm').addEventListener('submit', function(e) {
    ...
    .then(result => {
        if (result.ok) {
            ...
            showError('loginPasswordErr', result.data.error || "Login failed");
            shakeForm('loginForm');
        }
    });
    generateCaptcha('login');
...
document.getElementById('signupForm').addEventListener('submit', function(e) {
    ...
    .then(result => {
        if (result.ok) {
            ...
            showError('signupEmailErr', result.data.error || "Signup failed");
...
async function loadOpportunities() {
    ...
    data.forEach(o => {
        const skills = o.skills ? o.skills.split(",") : [];
        ...
        card.innerHTML = `
            ...
            <p class="opportunity-description">${o.description}</p>
            ...
            <div class="opportunity-footer">
                <span class="applicants-count">${o.max_applicants || 0} applicants</span>
